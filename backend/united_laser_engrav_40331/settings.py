"""
Django settings for united_laser_engrav_40331 project.
...
ROOT_URLCONF = 'united_laser_engrav_40331.urls'
...
WSGI_APPLICATION = 'united_laser_engrav_40331.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "united_laser_engrav_40331 API",
    "DESCRIPTION": "API documentation for united_laser_engrav_40331 App",
    "VERSION": "v1",
}
